        ...
        <div className={styles.wrapper}>
            ...
            <div class={styles.innerWrapper}>
                <div className={styles.box}>
                    ...
                    />
                    <h3>CONTEMPORARY</h3>
                    <p className={styles.text}>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div>
                <div className={styles.box}>
                    <Icon
                        inverted
                ...
                <div className={styles.box}>
                    ...
                    />
                    <h3>LONG LASTING</h3>
                    <p className={styles.text}>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
            </div>
        </div>
    )
